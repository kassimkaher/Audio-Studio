...
#ifndef VOICESTUDIOMAC_SWIFT_H
#define VOICESTUDIOMAC_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="VoiceStudioMac",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// hosted inside <code>AVAudioEngine</code> (there is no stock convolution AU in AVFoundation).
SWIFT_CLASS("_TtC14VoiceStudioMac20ConvolutionAudioUnit")
@interface ConvolutionAudioUnit : AUAudioUnit
